...
def test_youtube_invoke_failure_does_not_affect_published_count(
    ...
    mock_get_published_urls.return_value = (
        set(), [], {'pexels_ids': set(), 'image_urls': set(), 'cover_hashes': []}, [],
    )
    ...
    mock_ai.generate_footage_queries.return_value = (
        ['netherlands news'], [],
        {"place": "", "place_type": "none", "place_mode": "none",
         "queries": ['netherlands news'], "avoid": []},
    )
